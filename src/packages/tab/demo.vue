<template>
    <div>
        ...
        <nut-tab @tab-switch="tabSwitch">
            ...
            v-html="value.content"></nut-tab-panel>
        </nut-tab>
...
<style lang="scss">
    .customer-css .nut-tab-active .nut-tab-link{
      color:#fff;
      transition: all .3s cubic-bezier(.645,.045,.355,1);
    }
    .customer-css .nut-title-nav-list{
      background: #fff;
      border-left: 1px solid #e4e7ed;
    }
    .customer-css .nut-title-nav-list:first-child{
      border-left: 0;
    };
    .customer-css .nut-tab-active{
      background: $primary-color;
      border: 0;
    }
    .customer-css .nut-tab-link{
      width:100%;
    }
</style>
