<template>
  <div class="textinput-demo">
    ...
    <div>
      <nut-cell>
        <span slot="title">
          <nut-textinput placeholder="maxlength=5" maxlength="5" label="限制文字数：" :outline="false" :hasBorder="false" />
        </span>
      </nut-cell>
      <nut-cell>
        <span slot="title">
    ...
    <div>
      <nut-cell>
        <span slot="title">
          <nut-textinput placeholder="请输入内容" label="focus/blur事件：" @focus="onFocus" @blur="onBlur" v-model="val6" :hasBorder="false" />
        </span>
      </nut-cell>
      <nut-cell>
    ...
    <div>
      <nut-cell>
        <span slot="title">
          <nut-textinput class="my-input" v-model="val9" placeholder="请输入搜索内容" :clearBtnPersonnal="true">
