...
| title-class `v3.1.22`            | Custom title class                                                  | String                  | -       |
| lock-scroll `v3.1.22`            | Whether the background is locked                                    | Boolean                 | true    |
| title-icon `3.2.1`               | Custom title icon                                                   | String                  | -       |
...
| option-icon `v3.1.22` | Custom option icon | String | 'Check' |
| direction `v3.1.22` | Expand direction, can be set to up | String | 'down' |
| active-title-class `v3.2.0` | Active custom title class | String | - |
| inactive-title-class `v3.2.0` | Inactive custom title class | String | - |
