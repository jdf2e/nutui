<template>
  <div class="demo">
    ...
    <nut-category :category="category" @change="change">
      <nut-category-pane :category-child="categoryChild1" @onChange="onChange"> </nut-category-pane>
    </nut-category>
    <h2>{{ translate('title2') }}</h2>
    <nut-category :category="category" @change="changeText">
      <nut-category-pane type="text" :category-child="categoryChild2" @onChange="onChange"> </nut-category-pane
    ></nut-category>

    <h2>{{ translate('title3') }}</h2>
    <nut-category
      ><nut-category-pane type="custom" :custom-category="customCategory" @onChange="changeCustom"> </nut-category-pane
    ></nut-category>
  </div>
</template>
