...
| customClass`v3.1.22`  | 自定义 class                                                  | String                   |                      |
| overlayClass`v3.1.22` | 自定义遮罩类名                                                | String                   | -                    |
| overlayStyle`v3.1.22` | 自定义遮罩样式                                                | CSSProperties            | -                    |
| popClass `v3.1.22`    | 自定义 popup 弹框类名                                         | String                   | -                    |
| popStyle `v3.1.22`    | 自定义 popup 弹框样式                                         | CSSProperties            | -                    |
