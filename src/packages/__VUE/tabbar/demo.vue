<template>
  <div class="demo full">
    ...
    <nut-tabbar>
      <nut-tabbar-item :tab-title="translate('title')" :value="11">
        <template #icon>
          <Home></Home>
        </template>
      </nut-tabbar-item>
      <nut-tabbar-item :tab-title="translate('title')" :dot="true">
        <template #icon>
          <Home></Home>
        </template>
      </nut-tabbar-item>
      <nut-tabbar-item :tab-title="translate('title')" :value="110">
        <template #icon>
          <Home></Home>
        </template>
      </nut-tabbar-item>
