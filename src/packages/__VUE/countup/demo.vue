<template>
  <div class="demo">
    ...
    <div class="show-demo">
      <nut-countup
        :custom-change-num="data.customNumber"
        :custom-bg-img="data.bgImage"
        :custom-spac-num="11"
        :num-width="33"
        :num-height="47"
        :during="8000"
    ...
    <div class="show-demo">
      <nut-countup
        ref="countupMachine"
        type="machine"
        :machine-num="data.machineNum"
        :machine-prize-num="5"
        :machine-prize-level="data.prizeLevel"
        :machine-turn-more="5"
        :custom-bg-img="data.bgImage2"
        :num-width="100"
        :num-height="100"
        :during="3000"
      ...
      <div class="btnBtn">
        <nut-button type="danger" :disabled="data.startFlag" @click="startRole">{{ translate('btn1') }}</nut-button>
        <nut-button type="danger" :disabled="data.startFlag" @click="startRole2">{{ translate('btn2') }}</nut-button>
      </div>
    </div>
  </div>
</template>
