<template>
  <div class="demo">
    ...
    <nut-cell :title="translate('title')" :desc="text.one" is-link @click="showAddress"></nut-cell>
    ...
    <nut-cell :title="translate('title')" :desc="text.six" is-link @click="showSelected"></nut-cell>
    ...
    <nut-cell :title="translate('title')" :desc="text.five" is-link @click="showAddress2"></nut-cell>
    ...
    <nut-cell :title="translate('title')" :desc="text.two" is-link @click="showAddressExist"></nut-cell>
    ...
    <nut-cell :title="translate('title')" :desc="text.three" is-link @click="showCustomImg"></nut-cell>
    ...
    <nut-cell :title="translate('title')" :desc="text.four" is-link @click="showAddressOther"></nut-cell>
