<template>
  <div class="demo-list">
    ...
    <div>
      ...
      <nut-cell :is-link="true" :show-icon="true" @click="showDialog2" title="只有标题">
      </nut-cell>
      <nut-cell :is-link="true" :show-icon="true" @click="showDialog3" title="只有内容">
      </nut-cell>
      <nut-cell :is-link="true" :show-icon="true" @click="showDialog4" title="移除按钮栏">
      </nut-cell>
      <nut-cell :is-link="true" :show-icon="true" @click="showDialog5" title="事件">
      </nut-cell>
      <nut-cell
        :is-link="true"
        :show-icon="true"
      ...
      <nut-cell :is-link="true" :show-icon="true" @click="showDialog7" title="遮罩层透明">
      </nut-cell>
    </div>
    <h4>图片弹窗</h4>
    <p>
