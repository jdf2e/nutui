<template>
  <Demo>
    ...
    <h2>选中省市区</h2>
    <nut-cell title="选择地址" :desc="text.six" is-link @click="showSelected"></nut-cell>
    ...
    <h2>选择自定义地址2</h2>
    <nut-cell title="选择地址" :desc="text.five" is-link @click="showAddress2"></nut-cell>
    ...
    <h2>选择已有地址</h2>
    <nut-cell title="选择地址" :desc="text.two" is-link @click="showAddressExist"></nut-cell>
    ...
    <h2>自定义图标</h2>
    <nut-cell title="选择地址" :desc="text.three" is-link @click="showCustomImg"></nut-cell>
    ...
    <h2>自定义地址与已有地址切换</h2>
    <nut-cell title="选择地址" :desc="text.four" is-link @click="showAddressOther"></nut-cell>
