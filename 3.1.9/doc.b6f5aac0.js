import{e as a,o as n,E as t}from"./vendor.b9b5ce39.js";const l={class:"markdown-body"},p=t(`<h1>Searchbar\u7EC4\u4EF6</h1><h3>\u4ECB\u7ECD</h3><p>\u641C\u7D22\u680F</p><h3>\u5B89\u88C5</h3><pre><code class="language-javascript"><span class="hljs-keyword">import</span> { createApp, reactive, toRefs } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre><h3>\u663E\u793A\u641C\u7D22 icon</h3><pre><code class="language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">nut-searchbar</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;searchValue&quot;</span> <span class="hljs-attr">:has-left-in</span>=<span class="hljs-string">&quot;true&quot;</span>&gt;</span>
...
</code></pre><h3>\u53F3\u4FA7\u6DFB\u52A0\u641C\u7D22\u6587\u5B57</h3><pre><code class="language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">nut-searchbar</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;searchValue&quot;</span> <span class="hljs-attr">:has-right-out</span>=<span class="hljs-string">&quot;true&quot;</span>&gt;</span>
...
</code></pre><h3>\u663E\u793A\u5168\u90E8 icon</h3><pre><code class="language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">nut-searchbar</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;searchValue&quot;</span> <span class="hljs-attr">:has-left-in</span>=<span class="hljs-string">&quot;true&quot;</span> <span class="hljs-attr">:has-left-out</span>=<span class="hljs-string">&quot;true&quot;</span> <span class="hljs-attr">:has-right-in</span>=<span class="hljs-string">&quot;true&quot;</span> <span class="hljs-attr">:has-right-out</span>=<span class="hljs-string">&quot;true&quot;</span>&gt;</span>
