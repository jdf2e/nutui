import{e as t,o as a,G as n}from"./vendor.d7b11138.js";const l={class:"markdown-body"},p=n(`<h1>Searchbar\u7EC4\u4EF6</h1><h3>\u4ECB\u7ECD</h3><p>\u641C\u7D22\u680F</p><h3>\u5B89\u88C5</h3><pre><code class="language-javascript"><span class="hljs-keyword">import</span> { createApp, reactive, toRefs } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
